...
def test_consumer_commits_offsets_only_after_successful_hdfs_writes(tmp_path):
    ...
    assert fake_hdfs_client.calls == [
        ...
        (
            ...
            '{"timestamp":"2026-04-07T10:00:00+03:00","station_id":1,"station_name":null,"latitude":null,"longitude":null,"aqi":null,"dominant_pollutant":null,"pollutants":{},"temperature":null,"humidity":null,"wind":null,"pressure":null,"dew":null}\n',
        ),
    ]
